...
(function (global) {
   ...
   * state.lyrics.driftMs: extra calibration (positive = highlight earlier / more lead).
   * Fixed lead anticipates vocal onset when LRC stamps sit slightly late vs audio.
   */
  function lyricClockMs() {
    ...
    var tMs = Math.round(cur * 1000) - off + drift + 160;
    return tMs < 0 ? 0 : tMs;
  }
