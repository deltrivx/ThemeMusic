...
(function (global) {
  ...
  function buildUi() {
    ...
    root.innerHTML =
      ...
      '      <button type="button" class="ucwc-music-header-btn rescan" title="重新扫描本地曲库" aria-label="重新扫描曲库"><i class="fa fa-fw fa-refresh control" aria-hidden="true"></i></button>' +
      ...
      '      <button type="button" class="ucwc-music-close" title="本次隐藏（刷新后可再显示）" aria-label="隐藏音乐卡片"><i class="fa fa-fw fa-times control" aria-hidden="true"></i></button>' +
      "    </span>" +
      "  </span>" +
      "</div>" +
