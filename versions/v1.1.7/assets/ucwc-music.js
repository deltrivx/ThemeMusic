...
(function (global) {
  ...
  function onDocumentHidden(reason) {
    try {
      // Chip/both is the persistent playback mode. Keep its live Audio element
      // running across Unraid soft navigation and background visibility
      // changes; only persist position/intent for a possible full reload.
      if (isSitewidePlay()) {
